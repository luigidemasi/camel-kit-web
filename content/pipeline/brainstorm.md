...
The output is a greenfield Design Specification with six numbered design sections plus an unnumbered global **Not Doing (and Why)** scope section. It serves as the single source of truth for planning and implementation. Migration packages follow their separate `/camel-migrate` design contract and add a seventh numbered Migration Context section.
