...
One shared skill set is adapted for eight current AI targets. Each target adds native configuration and dispatch traits:
...
| `AntigravityGenerator` | Google Antigravity | `AGENTS.md` + `.agents/skills/` + `.agents/agents/` + `.agents/camel-kit-personas/` |
